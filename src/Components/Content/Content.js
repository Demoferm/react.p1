...
function Content(props) {
    ...
    const [[minRange,maxRange], setRange] = useState('0')
    ...
    return (
        <div className='row'>
            ...
            <h2 align='center'>Calculator</h2>
                    ...
                    <div className='col-6'>
                <p align='right'> <input type='text' placeholder='From' onChange={onChangeRangeMin}/></p>
                    </div>
                    <div className='col-6'>
                        <p align='left'> <input type='text' placeholder='To' onChange={onChangeRangeMax}/></p>
                    </div>
